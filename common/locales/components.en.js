export default {
  ...
  sidebar: {
    ...
    signUpHeader: 'We invite all educators, activists, artists, theoreticians, performers, musicians, hackers and everyone else to register and organise events (if you just want to attend an event at the festival you don\'t need to register).',
